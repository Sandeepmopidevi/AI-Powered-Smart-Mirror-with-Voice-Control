...
Module.register("compliments", {
	...
	defaults: {
		compliments: {
			anytime: [
			"Welcome to SRGEC Gudlavalleru!",
			"Excellence in Engineering & Innovation!"
		],
		morning: [
			"Good morning! A great day to learn!",
			"Rise and shine, future engineers!",
		...
		evening: [
			"Good evening! Keep striving for success!",
			"The journey of knowledge never ends!",
			"Tomorrow belongs to those who prepare today!"
		],
		"....-01-26": ["Happy Republic Day! Proud to be Indian!"],
		"....-08-15": ["Happy Independence Day! Let's celebrate freedom!"],
		"....-10-02": ["Happy Gandhi Jayanti! Truth & non-violence!"],

		// **Festival Holidays**
		"....-01-14": ["Happy Makar Sankranti! May your kites fly high!"],
		"....-03-08": ["Happy Holi! Let’s add color to our lives!"],
		"....-04-14": ["Happy Ambedkar Jayanti!"],
		"....-04-14": ["Happy Tamil New Year & Vishu!"],
		"....-05-01": ["Happy Labour Day!"],
		"....-08-29": ["Happy National Sports Day!"],
		"....-09-05": ["Happy Teacher’s Day! Thank you, mentors!"],
		"....-10-24": ["Happy Dussehra! Good wins over evil!"],
		"....-11-12": ["Happy Diwali! Let the lights shine bright!"],
		"....-12-25": ["Merry Christmas! Spread joy and love!"],

		// **Regional & Special Days**
		"....-01-01": ["Happy New Year! Let's make it great!"],
		"....-06-21": ["Happy International Yoga Day! Stay fit!"],
		"....-09-15": ["Happy Engineers’ Day! Innovate & inspire!"],
		"....-10-31": ["Happy National Unity Day! Salute to Sardar Patel!"]
		},
	...
	refreshMinimumDelay: 10 * 60 * 60 * 1000, // 10 minutes
	lastIndexUsed: -1,
